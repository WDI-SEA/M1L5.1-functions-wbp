...
const itemList = [shirtPrice,sweatshirtPrice,smallPosterPrice,largePosterPrice,mugPrice];
function previewFullPrice( item,salesTax,shippingPrice){
    let pricesAfterTax = item*(1+salesTax);
    let pricesAfterShipping = pricesAfterTax + shippingPrice;
    let pricesAfterShippingRounded = pricesAfterShipping.toFixed(2);
